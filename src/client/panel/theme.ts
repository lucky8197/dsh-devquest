 ...
 */
export const SKIN_PALETTES: Record<string, { brand: string; warn: string; success: string; overlay: string; layer2: string }> = {
 ...
 */
export function themeVars(themeId: string): CSSProperties {
...
export const CATEGORY_KEYS = ['journey', 'crafting', 'quest', 'time', 'legend', 'egg'] as const
