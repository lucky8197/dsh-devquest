	...
	const routes = makeDevQuestRoutes({
		...
		claimPass: async (tierId) => {
			...
			await new Promise((resolve, reject) => {
				enqueue(key, async () => {
					try {
						const claimed = claimPassTier(await getSave(key), tierId, Date.now(), seasonOverride);
						result = {
							ok: claimed.ok,
							gained: claimed.gained
						};
		...
		claimDailyGoal: async () => {
			...
			await new Promise((resolve, reject) => {
				enqueue(key, async () => {
					try {
						const claimed = claimDailyGoal(await getSave(key), Date.now(), seasonOverride);
						result = {
							ok: claimed.ok,
							gained: claimed.gained
						};
		...
		claimWeeklyBoss: async () => {
			...
			await new Promise((resolve, reject) => {
				enqueue(key, async () => {
					try {
						const claimed = claimWeeklyBoss(await getSave(key), Date.now());
						result = {
							ok: claimed.ok,
							gained: claimed.gained
						};
