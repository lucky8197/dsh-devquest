	...
	factory: (require) => {
		...
		*/
		function SectionCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					onClick: onToggle,
					style: {
						...sectionCardHeadStyle,
						...collapsed ? sectionCardHeadCollapsedStyle : {}
					},
					"aria-expanded": !collapsed,
					title: collapsed ? "展开" : "折叠",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: {
							...sectionCardTitleStyle,
							...collapsed ? sectionCardTitleCollapsedStyle : {}
						},
						children: title
		...
		function DevQuestPanelCard(props) {
			...
			const toggleSection = (id) => setCollapsed((cur) => ({
				...cur,
				[id]: !(cur[id] ?? false)
			}));
		...
		* 保证侧边栏等级与面板数据在打开面板前就已就绪。 */
		...
		const sectionCardTitleCollapsedStyle = { color: "#ffffff" };
		/** 折叠箭头。 */
