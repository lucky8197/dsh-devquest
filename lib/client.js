		...
		function DevQuestPanelCard(props) {
			...
			const claimPassTier = (0, react.useCallback)(async (tierId) => {
				try {
					...
					if (data.ok) setShopMsg({
						ok: true,
						text: t("dq.passClaimed", { xp: data.gained })
					});
				} catch {}
			}, [actions, t]);
			/** 使用任务跳过卡。 */
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionCard, {
							id: "ritual",
							title: `🌅 ${t("dq.ritual")}`,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SectionCard, {
							id: "daily",
							title: `📅 ${t("dq.daily")}`,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionCard, {
							...
							children: status.weekly !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [status.weekly.quests.map((q) => {
								const pct = Math.min(100, Math.round(Math.min(q.progress, q.goal) / Math.max(q.goal, 1) * 100));
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionCard, {
							...
							right: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								style: updatedStyle,
								children: [t("dq.pokedexOverall", { pct: Math.round((unlocked.length / Math.max(status.achievements.length, 1) + (status.shop?.themes ?? []).length / 7 + (status.titles?.items ?? []).filter((t) => t.unlocked).length / Math.max(status.titles?.items?.length ?? 1, 1)) / 3 * 100) }), "%"]
							}),
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												...
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { style: {
													...pokedexFillStyle,
													width: `${Math.round((status.shop?.themes ?? []).length / 7 * 100)}%`
												} })
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												style: pokedexNumStyle,
												children: [(status.shop?.themes ?? []).length, "/7"]
											})
										]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
