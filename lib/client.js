window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								status.stance !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									style: stanceBadgeStyle,
									title: t("dq.stance"),
									children: [
										status.stance.icon,
										" ",
										status.stance.name.zh
									]
								})
							]
						})
		...
		const eventCardHeadStyle = {
			fontSize: "calc(10px * var(--dq-fsz, 1))",
			fontWeight: 700,
			color: TONE.gold,
			letterSpacing: .3
		};
		const eventCardNameStyle = {
			fontSize: "calc(12px * var(--dq-fsz, 1))",
			fontWeight: 600,
			color: TONE.text
		};
		...
		const eventCardOptsStyle = {
			display: "flex",
			gap: 6,
			marginTop: 2
		};
		const eventOptButtonStyle = {
			flex: 1,
			marginTop: 0,
			textAlign: "center"
		};
		...
		function AdventureSection(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SectionCard, {
				...
				right: buffs.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: updatedStyle,
					children: t("dq.buffCount", { n: buffs.length })
				}) : void 0,
				...
				children: [
					choices.map((ev) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: eventCardNameStyle,
									children: def.name.zh
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: eventCardDescStyle,
									children: def.description.zh
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: eventCardOptsStyle,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => onResolve(ev.id, 0),
										disabled: resolving !== null,
										style: {
											...shopBuyButtonStyle,
											...eventOptButtonStyle
										},
										children: t("dq.eventChoiceA")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => onResolve(ev.id, 1),
										disabled: resolving !== null,
										style: {
											...shopBuyButtonStyle,
											...eventOptButtonStyle
										},
										children: t("dq.eventChoiceB")
									})]
								})
							]
						}, ev.id);
					...
					buffs.map((ev) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: buffRowStyle,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: def.icon }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: buffNameStyle,
									children: def.name.zh
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: buffRemainStyle,
									children: ev.expiresTurns !== void 0 ? `⏳${ev.expiresTurns}` : t("dq.buffActive")
								})
							]
						}, ev.id);
					}),
					events.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: emptyStyle,
						children: t("dq.adventureEmpty")
					})
				]
			});
		}
		/** 🪙 圣物收藏分区。 */
		const relicGridStyle = {
			display: "flex",
			flexDirection: "column",
			gap: 6
		};
		const relicRarityLabelStyle = {
			fontSize: "calc(9px * var(--dq-fsz, 1))",
			color: TONE.quiet,
			textTransform: "uppercase",
			letterSpacing: .4,
		...
		function RelicsSection(props) {
			...
			const labels = {
				common: t("dq.rarity.common"),
				rare: t("dq.rarity.rare"),
				epic: t("dq.rarity.epic"),
				legendary: t("dq.rarity.legendary")
			};
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionCard, {
				...
				children: items.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: emptyStyle,
					children: t("dq.relicsEmpty")
				}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: relicGridStyle,
					children: order.map((r) => {
						const group = items.filter((x) => x.rarity === r);
						if (group.length === 0) return null;
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								...relicRarityLabelStyle,
								color: relicRarityColor[r]
							},
							children: [
								labels[r] ?? r,
								" · ",
							...
							style: relicRowStyle,
							children: group.map((x) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: {
									...relicCellStyle,
									borderColor: `color-mix(in srgb, ${relicRarityColor[x.rarity] ?? "#718096"} 40%, transparent)`
								},
								title: `${x.name.zh} ${x.name.en}`,
								children: x.icon
							}, x.id))
						})] }, r);
					})
		...
		/** 📜 史诗任务链分区。 */
		const chainNameStyle = {
			fontSize: "calc(11px * var(--dq-fsz, 1))",
			fontWeight: 700,
			color: TONE.text,
			marginBottom: 4
		};
		const chainStepStyle = {
			display: "flex",
			alignItems: "center",
			gap: 6,
			padding: "2px 0"
		};
		const chainStepLabelStyle = {
			fontSize: "calc(10px * var(--dq-fsz, 1))",
			color: TONE.muted,
			lineHeight: 1.4
		};
		function ChainSection(props) {
			...
			if (ch === null) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, {});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SectionCard, {
				id: "chain",
				title: `📜 ${t("dq.chain")}`,
				right: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: updatedStyle,
					children: ch.finished ? t("dq.chainDone") : `${ch.step}/${ch.total}`
				}),
				...
				children: [
					...
					ch.steps.map((s, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: chainStepStyle,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: { opacity: s.met ? 1 : .5 },
							children: s.met ? "✅" : "⏳"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: {
								...chainStepLabelStyle,
								...s.met ? { color: TONE.green } : {}
							},
							children: s.label.zh
						})]
					}, i)),
					ch.finished && !ch.claimed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => void onClaim(),
						disabled: claiming,
						style: weeklyBonusButtonStyle,
						children: claiming ? "…" : t("dq.chainClaim", { xp: ch.rewardXp })
					}),
					ch.claimed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: weeklyBonusClaimedStyle,
						children: t("dq.chainClaimedDone")
					})
				]
			});
		}
		...
		function GhostSection(props) {
			const { status, t, collapsedMap, toggle, onClaim, claiming } = props;
			const g = status.ghostRace;
			if (g === void 0 || !g.active) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, {});
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SectionCard, {
				id: "ghost",
				title: `👻 ${t("dq.ghost")}`,
				right: g.beaten ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: weeklyBonusClaimedStyle,
					children: t("dq.ghostBeaten")
				}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: updatedStyle,
					children: t("dq.ghostVs")
				}),
				...
				children: [
					...
					g.beaten && !g.claimed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => void onClaim(),
						disabled: claiming,
						style: weeklyBonusButtonStyle,
						children: claiming ? "…" : t("dq.ghostClaim")
					}),
					g.claimed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: weeklyBonusClaimedStyle,
						children: t("dq.ghostClaimedDone")
					})
				]
			});
		}
		...
		*/
		...
		function DevQuestPanelCard(props) {
			...
			const [eventResolving, setEventResolving] = (0, react.useState)(null);
			/** 结算事件卡抉择（choice 型：选项 0/1）。 */
			const resolveEventF = (0, react.useCallback)(async (eventId, option) => {
				if (eventResolving !== null) return;
				setEventResolving(eventId);
				try {
					const data = await (await fetch("/api/devquest/event/resolve", {
						method: "POST",
						headers: { "content-type": "application/json" },
						body: JSON.stringify({
							eventId,
					...
					} else notify(false, data.label ?? apiErrorOf(data) ?? t("dq.opFailed"));
				} catch {
					notify(false, t("dq.opFailed"));
				} finally {
			...
			const [chainClaiming, setChainClaiming] = (0, react.useState)(false);
			/** 领取史诗任务链终章奖励。 */
			const claimChainF = (0, react.useCallback)(async () => {
				if (chainClaiming) return;
				setChainClaiming(true);
				try {
					const data = await (await fetch("/api/devquest/chain/claim", { method: "POST" })).json();
					if (data.status !== null && data.status !== void 0) actions.setStatus(data.status);
					if (data.ok) {
			...
			const [ghostClaiming, setGhostClaiming] = (0, react.useState)(false);
			/** 领取幽灵竞速奖励（击败上周的自己）。 */
			const claimGhostF = (0, react.useCallback)(async () => {
				if (ghostClaiming) return;
				setGhostClaiming(true);
				try {
					const data = await (await fetch("/api/devquest/ghost/claim", { method: "POST" })).json();
					if (data.status !== null && data.status !== void 0) actions.setStatus(data.status);
					if (data.ok) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AdventureSection, {
							collapsedMap: collapsed,
							toggle: toggleSection,
							status,
							t,
							onResolve: (id, opt) => void resolveEventF(id, opt),
							resolving: eventResolving
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChainSection, {
							collapsedMap: collapsed,
							toggle: toggleSection,
							status,
							t,
							onClaim: claimChainF,
							claiming: chainClaiming
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(GhostSection, {
							collapsedMap: collapsed,
							toggle: toggleSection,
							status,
							t,
							onClaim: claimGhostF,
							claiming: ghostClaiming
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RelicsSection, {
							collapsedMap: collapsed,
							toggle: toggleSection,
							status,
							t
		...
		* 保证侧边栏等级与面板数据在打开面板前就已就绪。 */
		function DevQuestOverlay(props) {
			...
			const [uiSettingsVersion, setUiSettingsVersion] = (0, react.useState)(0);
			(0, react.useEffect)(() => {
			...
			(0, react.useEffect)(() => {
				...
				for (const toast of state.toasts) {
					...
					if (toast.kind === "achievement") {
						...
						if (def !== void 0 && rarityWeight(def.rarity) < rarityWeight("rare")) actions.dismissToast(toast.id);
					}
				}
			}, [
				state.toasts,
		...
		*/
		...
		const zh = {
			...
			"dq.counters": "计数",
			"dq.adventure": "冒险事件",
			"dq.adventureEmpty": "暂无事件——每完成 20 个回合掷一次命运骰子",
			"dq.eventTitle": "命运骰子",
			"dq.eventChoiceA": "选项 A",
			"dq.eventChoiceB": "选项 B",
			"dq.buffCount": "生效 {n} 个",
			"dq.buffActive": "生效中",
			"dq.stance": "连击姿态",
			"dq.relics": "圣物收藏",
			"dq.relicsCount": "{n}/{m}",
			"dq.relicsEmpty": "还没捡到圣物——全清待办/击败 BOSS 有概率掉落",
			"dq.chain": "史诗任务",
			"dq.chainDone": "待领奖",
			"dq.chainClaim": "🎉 领取终章奖励 +{xp} XP",
			"dq.chainClaimed": "史诗任务完成 +{xp} XP",
			"dq.chainClaimedDone": "终章奖励已领取",
			"dq.ghost": "幽灵竞速",
			"dq.ghostVs": "vs 上周的你",
			"dq.ghostTurnsLabel": "回合",
			"dq.ghostBeaten": "已击败 ✓",
			"dq.ghostClaim": "领击败奖励",
			"dq.ghostClaimed": "击败上周的自己 +{xp} XP",
			"dq.ghostClaimedDone": "奖励已领取"
		};
		const en = {
			...
			"dq.adventure": "Adventure",
			"dq.adventureEmpty": "No events — the dice roll every 20 turns",
			"dq.eventTitle": "Fate Dice",
			"dq.eventChoiceA": "Option A",
			"dq.eventChoiceB": "Option B",
			"dq.buffCount": "{n} active",
			"dq.buffActive": "active",
			"dq.stance": "Combo stance",
			"dq.relics": "Relics",
			"dq.relicsCount": "{n}/{m}",
			"dq.relicsEmpty": "No relics yet — clear todos / beat bosses to drop",
			"dq.chain": "Epic Quest",
			"dq.chainDone": "Reward ready",
			"dq.chainClaim": "🎉 Claim finale +{xp} XP",
			"dq.chainClaimed": "Epic quest complete +{xp} XP",
			"dq.chainClaimedDone": "Finale claimed",
			"dq.ghost": "Ghost Race",
			"dq.ghostVs": "vs Past You",
			"dq.ghostTurnsLabel": "turns",
			"dq.ghostBeaten": "Beaten ✓",
			"dq.ghostClaim": "Claim victory reward",
			"dq.ghostClaimed": "Beat Past You +{xp} XP",
			"dq.ghostClaimedDone": "Reward claimed"
		};
		//#endregion
