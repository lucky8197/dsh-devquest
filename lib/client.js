		...
		*/
		...
		function DevQuestPanelCard(props) {
			...
			const refresh = (0, react.useCallback)(() => {
				...
				fetch(`${STATUS_API}${query}`, { signal: controller.signal }).then((response) => {
			...
			if (status === null) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					style: {
						...cardHeaderStyle,
						...dragging ? cardHeaderDraggingStyle : {}
					},
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							}), wallOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: tabsStyle,
			...
			if (!wide) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SwordIcon, { size: 19 })
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		const wallCellLockedStyle = { opacity: .55 };
		const wallXpStyle = {
			fontSize: 8,
			color: TONE.quiet
		};
