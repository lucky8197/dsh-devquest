...
import { SEASON_GOAL_TOKENS, categoryIcon, comboMultiplier, dayKeyLocal, formatNumber, formatTime, levelPercent, loadCollapsed, rarityCellStyle, saveCollapsed, seasonDaysLeft, titleToneStyle, updatedLabel } from "./util.js";
...
export function RitualSection(props) {
    ...
    const [collapsedMap, setCollapsedMap] = useState(loadCollapsed);
    const toggle = (id) => {
