...
const streakNextStyle = { fontSize: 9, color: TONE.quiet };
const boostStockStyle = { marginLeft: 'auto', fontSize: 9, color: TONE.gold, whiteSpace: 'nowrap' };
/** v1.1 赛季通行证行。 */
...
const ritualGreetingStyle = { fontSize: 12, fontWeight: 700, color: 'var(--dsw-alias-label-primary, #1a2230)' };
const ritualSummaryStyle = { fontSize: 10, color: TONE.muted };
...
const pokedexIconStyle = { fontSize: 14, width: 18, textAlign: 'center' };
const pokedexNameStyle = { fontSize: 10, color: TONE.text, width: 52, flexShrink: 0 };
...
const pokedexNumStyle = { fontSize: 9, color: TONE.quiet, width: 34, textAlign: 'right', fontVariantNumeric: 'tabular-nums' };
/** v1.2.0 设置区。 */
const settingsRowStyle = { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, padding: '3px 0' };
const settingsLabelStyle = { fontSize: 10, color: TONE.text };
const settingsControlStyle = { display: 'flex', alignItems: 'center', gap: 6 };
const settingsValueStyle = { fontSize: 10, color: TONE.gold, minWidth: 36, textAlign: 'center', fontVariantNumeric: 'tabular-nums' };
