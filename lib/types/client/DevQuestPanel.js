...
function SectionCard(props) {
    ...
    return _jsxs("section", { style: sectionCardStyle, "data-section": id, "data-collapsed": collapsed ? 'true' : 'false', children: [_jsxs("button", { type: "button", onClick: onToggle, style: { ...sectionCardHeadStyle, ...(collapsed ? sectionCardHeadCollapsedStyle : {}) }, "aria-expanded": !collapsed, title: collapsed ? '展开' : '折叠', children: [_jsx("span", { style: { ...sectionCardTitleStyle, ...(collapsed ? sectionCardTitleCollapsedStyle : {}) }, children: title }), _jsxs("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6 }, children: [right, _jsx("span", { style: { ...sectionCardArrowStyle, ...(collapsed ? sectionCardTitleCollapsedStyle : {}) }, children: collapsed ? '▸' : '▾' })] })] }), !collapsed && _jsx("div", { style: sectionCardBodyStyle, children: children })] });
}
...
const sectionCardHeadCollapsedStyle = {
    borderBottom: 'none',
...
const sectionCardTitleCollapsedStyle = {
    color: '#ffffff',
};
/** 折叠箭头。 */
...
const questTrackStyle = { height: 6, borderRadius: 3, background: 'color-mix(in srgb, var(--dsw-alias-bg-layer-2, #1d2735) 65%, transparent)', border: `1px solid ${TONE.border}`, overflow: 'hidden' };
...
const tooltipProgressTrackStyle = { height: 3, borderRadius: 2, background: 'color-mix(in srgb, var(--dsw-alias-label-tertiary, #718096) 22%, transparent)', border: `1px solid ${TONE.border}`, overflow: 'hidden' };
...
const sprintTrackStyle = { flex: 1, height: 4, borderRadius: 2, background: 'color-mix(in srgb, var(--dsw-alias-label-tertiary, #718096) 22%, transparent)', border: `1px solid ${TONE.border}`, overflow: 'hidden' };
...
const weeklyQuestTrackStyle = { height: 4, borderRadius: 2, background: 'color-mix(in srgb, var(--dsw-alias-bg-layer-2, #1d2735) 65%, transparent)', border: `1px solid ${TONE.border}`, overflow: 'hidden' };
