...
export function DevQuestPanelCard(props) {
    ...
    return _jsxs("section", { ref: cardRef, style: {
        ...
        }, "data-devquest": true, onPointerDown: onCardPointerDown, onPointerMove: onCardPointerMove, onPointerUp: onCardPointerUp, onPointerCancel: onCardPointerCancel, children: [_jsxs("header", { style: cardHeaderStyle, children: [_jsx("span", { style: { color: TONE.accent, display: 'inline-flex' }, children: _jsx(SwordIcon, { size: 20 }) }), _jsx("strong", { style: cardTitleStyle, children: "DevQuest" }), status.version !== undefined && status.version !== '' && (_jsx("span", { style: versionLabelStyle, title: t('dq.version'), children: status.version })), _jsx("button", { type: "button", onClick: expandAll, "aria-label": t('dq.expandAll'), title: t('dq.expandAll'), style: iconButtonStyle, children: "\u2922" }), _jsx("button", { type: "button", onClick: collapseAll, "aria-label": t('dq.collapseAll'), title: t('dq.collapseAll'), style: iconButtonStyle, children: "\u2921" }), _jsx("button", { type: "button", onClick: () => actions.setOpen(false), "aria-label": t('dq.close'), style: iconButtonStyle, children: _jsx(CloseIcon, {}) })] }), _jsxs("div", { style: cardBodyStyle, children: [_jsx(HeroSection, { status: status, t: t, c: c, percent: percent, refresh: refresh, claimPassTier: claimPassTier }), _jsx(SeasonSummaryCard, { status: status, t: t }), _jsx(DailyGoalCard, { status: status, t: t, claimDailyGoalF: claimDailyGoalF }), panelMsg !== null && (_jsxs("div", { style: panelMsgStyle(panelMsg.ok), role: "status", children: [panelMsg.ok ? '✅ ' : '⚠️ ', panelMsg.text] })), _jsx(RitualSection, { status: status, t: t, questReminderMsg: questReminderMsg }), _jsx(LuckyRow, { status: status, t: t, claimingLucky: claimingLucky, luckyMsg: luckyMsg, claimLuckyDraw: claimLuckyDraw }), _jsx(DailySection, { status: status, t: t, claiming: claiming, claimChest: claimChest }), _jsx(WeeklySection, { status: status, t: t, weeklyClaiming: weeklyClaiming, claimBossF: claimBossF, claimWeekly: claimWeekly }), _jsx(ShopSection, { status: status, t: t, buying: buying, confirmBuyId: confirmBuyId, buy: buy, rerolling: rerolling, rerollQuests: rerollQuests, useQuestSkipCard: useQuestSkipCard }), _jsx(SkinsSection, { status: status, t: t, buying: buying, confirmBuyId: confirmBuyId, buy: buy, activateTheme: activateTheme }), _jsx(TutorialSection, { status: status, t: t }), _jsx(TitlesSection, { status: status, t: t, sharing: sharing, shareCard: shareCard, shareSeason: shareSeason, switchTitle: switchTitle }), _jsx(CollectionsSection, { status: status, t: t, importing: importing, exportSave: exportSave, importSave: importSave }), _jsx(PokedexSection, { status: status, t: t, unlocked: unlocked }), _jsx(RecentSection, { status: status, t: t, state: state, recent: recent }), _jsx(WallSection, { status: status, t: t, category: category, setCategory: setCategory, wallSearch: wallSearch, setWallSearch: setWallSearch, wallRarity: wallRarity, setWallRarity: setWallRarity, wallStatus: wallStatus, setWallStatus: setWallStatus, hover: hover, setHover: setHover, wallItems: wallItems, milestone: milestone, unlocked: unlocked }), _jsx(ReportSection, { status: status, t: t }), _jsx(CalendarSection, { status: status, t: t }), _jsx(StatsSection, { status: status, t: t, c: c }), _jsx(SettingsSection, { status: status, t: t, settings: settings, updateSettings: updateSettings, setGoalF: setGoalF })] })] });
}
// ---------------------------------------------------------------------------
// 成就 toast
// ---------------------------------------------------------------------------
