...
function SectionCard(props) {
    ...
    return _jsxs("section", { style: sectionCardStyle, "data-section": id, children: [_jsxs("button", { type: "button", onClick: onToggle, style: sectionCardHeadStyle, "aria-expanded": !collapsed, children: [_jsx("span", { style: sectionCardTitleStyle, children: title }), _jsxs("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6 }, children: [right, _jsx("span", { style: sectionCardArrowStyle, children: collapsed ? '▸' : '▾' })] })] }), !collapsed && _jsx("div", { style: sectionCardBodyStyle, children: children })] });
}
