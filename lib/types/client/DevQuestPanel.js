...
const DEFAULT_SETTINGS = { fontSize: 1, compact: false, toastFilter: 'all' };
            ...
            ...(settings.compact ? {
                ...
                '--dq-hero-mb': '8px',
                            ...
                            : _jsxs("span", { style: titleHeadCurrentStyle, children: [t('dq.titleFollowLevel'), " \u00B7 ", status.title.zh] }), collapsed: isCollapsed('titles'), onToggle: () => toggleSection('titles'), children: [_jsxs("div", { style: titleCurrentRowStyle, children: [_jsx("span", { style: { fontSize: 'calc(15px * var(--dq-fsz, 1))' }, children: status.titles?.current?.icon ?? '🎖️' }), _jsx("span", { style: titleCurrentNameStyle, children: status.titles?.current !== null
                                            ...
                                            : `${t('dq.titleFollowLevel')} · ${status.title.zh}` }), _jsx("button", { type: "button", onClick: () => void shareCard(), disabled: sharing, style: shareButtonStyle, children: sharing ? '…' : `📤 ${t('dq.share')}` }), _jsx("button", { type: "button", onClick: () => void shareSeason(), disabled: sharing, style: shareButtonStyle, children: sharing ? '…' : `📊 ${t('dq.shareSeason')}` })] }), _jsxs("div", { style: titleListStyle, children: [_jsxs("button", { type: "button", onClick: () => void switchTitle(''), style: { ...titleItemStyle, ...(status.titles?.current === null ? titleItemActiveStyle : {}) }, children: [_jsx("span", { children: "\uD83C\uDF96\uFE0F" }), _jsxs("span", { style: titleItemNameStyle, children: [t('dq.titleFollowLevel'), " \u00B7 ", status.title.zh] }), status.titles?.current === null && _jsx("span", { style: titleItemActiveMarkStyle, children: t('dq.titleActive') })] }), (status.titles?.items ?? []).map(ti => (_jsxs("button", { type: "button", onClick: () => { if (ti.unlocked)
